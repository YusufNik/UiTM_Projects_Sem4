...
if(isset($_POST['update'])){
    ...
    if ($rowSel == 0) {
        echo "<script>alert('Record does not exist!'); window.location= 'menu_catalog.php'</script>";
    } else {
        ...
        echo "<script>alert('Data has been updated!'); window.location= 'menu_catalog.php'</script>";
    }
        ...
        // Display a message and redirect
        echo "<script>alert('Data has been deleted!'); window.location= 'menu_catalog.php'</script>";
    } else {
        // Redirect if neither update nor delete button was clicked
        echo "<script>alert('Error! Action unsuccessful'); window.location= 'menu_catalog.php'</script>";
    }
