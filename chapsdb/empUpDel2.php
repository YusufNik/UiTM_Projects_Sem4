...
if (isset($_POST['update'])) {
    ...
    if ($rowSel == 0) {
        echo "<script>alert('Record does not exist!'); window.location= 'menu_homeS.php'</script>";
    } else {
        ...
        // Display a message
        echo "<script>alert('Data has been updated!'); window.location= 'menu_homeS.php'</script>";
    }
} 
?>