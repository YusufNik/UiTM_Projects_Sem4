...
<body>
    ...
    <div class="container" id="container">
        ...
        <form action="empUpDel2.php" method="post" enctype="multipart/form-data">
                ...
                <table>
                    <tr>
                        <td rowspan="2">
                        <button  type="button" onclick="window.location.href='menu_homeS.php';"><span class="material-symbols-outlined">arrow_back</span>BACK</button></td>
