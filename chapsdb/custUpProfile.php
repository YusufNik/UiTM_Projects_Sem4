...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action = "custUpProfile2.php" method = "post">
                ...
                <table>
                    <tr>
                        <td roswspan="2">
                            <button  type="button" onclick="window.location.href='menu_catalog.php';"><span class="material-symbols-outlined">arrow_back</span>BACK</button></td>
